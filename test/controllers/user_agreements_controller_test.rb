...
class UserAgreementsControllerTest < ActionController::TestCase
  ...
  test "should create user_agreement" do
    assert_difference('UserAgreement.count') do
      post :create, user_agreement: { accepted: @user_agreement.accepted, agreement_id: @user_agreement.agreement_id, user_id: @user_agreement.user_id }
    end
  ...
  test "should update user_agreement" do
    patch :update, id: @user_agreement, user_agreement: { accepted: @user_agreement.accepted, agreement_id: @user_agreement.agreement_id, user_id: @user_agreement.user_id }
    assert_redirected_to user_agreement_path(assigns(:user_agreement))
  end
