...
class MetricsControllerTest < ActionController::TestCase
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post :create, metric: { description: @metric.description, gallina_id: @metric.gallina_id, name: @metric.name, weight: @metric.weight }
    end
  ...
  test "should update metric" do
    patch :update, id: @metric, metric: { description: @metric.description, gallina_id: @metric.gallina_id, name: @metric.name, weight: @metric.weight }
    assert_redirected_to metric_path(assigns(:metric))
  end
